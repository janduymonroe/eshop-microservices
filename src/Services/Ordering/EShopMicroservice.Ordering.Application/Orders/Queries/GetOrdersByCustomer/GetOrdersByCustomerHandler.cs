namespace EShopMicroservice.Ordering.Application.Orders.Queries.GetOrdersByCustomer;
    ...
    : IQueryHandler<GetOrdersByCustomerQuery, GetOrdersByCustomerResult>
{
    public async Task<GetOrdersByCustomerResult> Handle(GetOrdersByCustomerQuery request, CancellationToken cancellationToken)
    {
        ...
        return new GetOrdersByCustomerResult(orders.Select(OrderDto.FromOrder));
    }
}
